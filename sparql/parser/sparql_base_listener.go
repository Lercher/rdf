...
func (s *BaseSparqlListener) EnterFilter(ctx *FilterContext) {}

// ExitFilter is called when production filter is exited.
func (s *BaseSparqlListener) ExitFilter(ctx *FilterContext) {}
...
func (s *BaseSparqlListener) EnterObject(ctx *ObjectContext) {}

// ExitObject is called when production object is exited.
func (s *BaseSparqlListener) ExitObject(ctx *ObjectContext) {}
...
// EnterVarx is called when production varx is entered.
func (s *BaseSparqlListener) EnterVarx(ctx *VarxContext) {}

// ExitVarx is called when production varx is exited.
func (s *BaseSparqlListener) ExitVarx(ctx *VarxContext) {}
...
func (s *BaseSparqlListener) EnterRdfstring(ctx *RdfstringContext) {}

// ExitRdfstring is called when production rdfstring is exited.
func (s *BaseSparqlListener) ExitRdfstring(ctx *RdfstringContext) {}
